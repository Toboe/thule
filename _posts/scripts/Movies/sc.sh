find /mnt/ftp/torrents/downloads -iname '*' -print | sed -n -E -e 's/.*.avi$/&/p' -e 's/.*.m4b$/&/p'  -e 's/.*.mkv$/&/p' -e 's/.*.vob$/&/p' -e 's/.*.m4v$/&/p' -e 's/.*.mp4$/&/p' -e 's/.*.VOB$/&/p' -e 's/.*.wmv$/&/p' > /mnt/ftp/torrents/play.m3u 
...
vlc /mnt/ftp/torrents/play.m3u --extraintf ncurses --http-host 192.168.1.1:8081 -I http --sout udp://192.168.1.$1
